...
const Product = () => {
  ...
  return (
    <div className="mt-24 min-h-[70vh]">
      <div className="max-w-screen-xl mx-auto my-10 flex flex-col lg:flex-row gap-8 px-4">
        ...
        <div className="w-full sm:w-3/5 flex flex-col justify-center gap-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex gap-3 items-center justify-between border w-32 py-1 px-4 text-gray-500">
            ...
            <button
              ...
              className="bg-black text-white py-3 px-6 rounded-lg hover:bg-gray-800 active:bg-black"
            >
              Add to Cart
            </button>
          </div>
